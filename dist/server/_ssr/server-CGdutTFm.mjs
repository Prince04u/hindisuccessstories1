...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Devbd0L7.mjs");
...
const manifest = {
  "9ff7ac682d569ace29ac9f4c109dfff01a123caf2fc3a87d7b131f0a854906ad": {
    ...
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  "34a31ade313c18d5c6c21e83cad948e870ac5e3521a9ffa64f8cce35880a8756": {
    functionName: "adminListArticles_createServerFn_handler",
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  "546171a97634419c95d40616d8e8e6cafd86379c9722a699d74e58976f1de2b3": {
    functionName: "adminUpdateArticle_createServerFn_handler",
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  ...
  "854d1be6452ea29ff22809ac0418cb9979d5f84b7a9e1fb1a906a63fd64b1049": {
    functionName: "adminToggleRole_createServerFn_handler",
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  ...
  "bb5473d75bde18bdd302527cc59292d9091259a2f9b9b7c500aedb666bd44391": {
    functionName: "adminUpdateSubmission_createServerFn_handler",
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  ...
  "2dec6bc76df69550b854e186eca41d9ccccf62dc731f453c7c498b28ca051006": {
    functionName: "adminToggleCommentHidden_createServerFn_handler",
    importer: () => import("./admin.functions-ChbPfGTU.mjs")
  },
  "5dbf46616266e7bfe81c82694a91090a42de6200b3efc1b9d156faf41ac3a479": {
    functionName: "getMyProfile_createServerFn_handler",
    importer: () => import("./profile.functions-C0Bc7hN3.mjs")
  },
  "af00eb763dce352dc2f42ef901ef426a138feb40fdc7f79166552837a77fae5f": {
    functionName: "updateMyProfile_createServerFn_handler",
    importer: () => import("./profile.functions-C0Bc7hN3.mjs")
  },
  "f7f81015ee3789a318310c65d82db2fe90bae34aef8cabac006a1e336db5b40a": {
    functionName: "listHomeArticles_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "56247e6ee3d304c48058f8d110f119240330676c76ca2e2c888dd810ae82630f": {
    functionName: "getArticleBySlug_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "c2b8a8bc7954647241400f9e2a6c5f50e533c1a24a83b85fe9b66049775e6357": {
    functionName: "listByCategory_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "f4beb373092b23b59832940dff11c0bd4e64de3730d485087e2bb8cde688f9e4": {
    functionName: "listByAuthor_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "974c53e9c39bdbac0e2f1c6a5f7e04b7d77cff5bebf8dbe7ff250205637e0e79": {
    functionName: "saveArticle_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "fc0b54c30fa6d2ed5ec71c58f8346a07913e7001e132861d54485c6bae3c83de": {
    functionName: "getMyArticle_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "5980e3461ebb14456b01158b6c14ee9f03eb64b35cf28a4e4bdbccf412ebcda0": {
    functionName: "listMyArticles_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "8f60ed66cb3c64c9d8f219fb14aff3baf8a5d9242e4eaee072c6824341602764": {
    functionName: "deleteMyArticle_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "6db7c8a3537bd9238475af8d32ed3e693f0b334a65e22320cd5b98d6b5565beb": {
    functionName: "toggleLike_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "eb6d610105595061a50a2c1345251b7a1082da6bd585f4f862fdee8130e5f1f8": {
    functionName: "addComment_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "0898f266f135eb28b19a711a0f7d1cb195af20139abdacc6b1c9f99af2732554": {
    functionName: "toggleFollow_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "0bd1d1bd5fbee8184b58dabdde6c99056d09cf4afa7cfec67309ae5145076e58": {
    functionName: "subscribeNewsletter_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  },
  "1a31922b8f3d72d22be102fed306d97dcb9346ca7f64913003a96d7dd4e3bfef": {
    functionName: "submitGuestPost_createServerFn_handler",
    importer: () => import("./articles.functions-DSCoogGw.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dl0oPtZv.mjs").then((n) => n.r),
    import("./start-DkPtuk6W.mjs"),
